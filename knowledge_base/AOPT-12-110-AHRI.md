## AOPT-12-110-AHRI - Página 1

### Certificate of Product Ratings
Certificate of Product Ratings

### Sección 1 - Información principal del certificado
AHRI Certified Reference Number : 217284769    Date : 06-13-2025    Model Status : Active  
...
Outdoor Unit Model Number : AOPT-12R32-110-E  
Indoor Type : Mini-Splits (Non-Ducted)  
Indoor Model Number(s) : AOPT-12R32-110-I
...
### Tabla: Valores de rendimiento (convertida a texto estructurado)
- **Cooling Capacity (A Full) – Single or High Stage (95F), btuh:** 12000
- **SEER2:** 20.00
- **EER2 (A Full) – Single or High Stage (95F):** 12.00

### Sección 2 - Marca y elementos gráficos
- Gran logotipo: AHRI CERTIFIED
- URL visible en encabezado/elementos gráficos: www.ahridirectory.org
...
### Encabezados y pies de página / Información adicional
- ©2025 Air-Conditioning, Heating, and Refrigeration Institute
- Sello/Logo AHRI con texto: we make life better™

### Información del certificado (ubicada en la esquina inferior derecha)
- CERTIFICATE NO.: 133943095899752469

(Archivo: AOPT-12-110-AHRI — Página 1)