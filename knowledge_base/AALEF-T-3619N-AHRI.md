## AALEF-T-3619N-AHRI - Página 1

### Certificate of Product Ratings
Certificate of Product Ratings

### Datos principales (archivo: AALEF-T-3619N-AHRI, Página 1)
- **AHRI Certified Reference Number :** 214291421
- **Date :** 01-08-2025
- **Model Status :** Active
...
- **Outdoor Unit Model Number :** AALEF-T-3619N-E
- **Indoor Type :** Mini-Splits (Non-Ducted)
- **Indoor Model Number(s) :** AALEF-T-3619N-I
...
### Calificaciones y especificaciones técnicas
...
- **SEER2 :** 19.00
- **EER2 (A Full) — Single or High Stage (95F) :** 9.00

- **Sold in? :** USA, Canada, Outside USA and Canada

### Notas y leyendas (archivo: AALEF-T-3619N-AHRI, Página 1)
...
- The Department of Energy has published updated energy efficiency metrics for central air conditioners for central air conditioners and heat pump/air conditioners the published metrics for central air conditioners and heat pump/air conditioners the 1987 metric (SEER) and the 2023 metric (SEER2). Efficiency requirements are published at 10 C.F.R. 430.32(c). Please refer to www.AHRInet.org for more information about updated energy efficiency metrics.

### DISCLAIMER (archivo: AALEF-T-3619N-AHRI, Página 1)
...
### TERMS AND CONDITIONS (archivo: AALEF-T-3619N-AHRI, Página 1)
...
### CERTIFICATE VERIFICATION (archivo: AALEF-T-3619N-AHRI, Página 1)
...
### Información adicional (archivo: AALEF-T-3619N-AHRI, Página 1)
- ©2025 Air-Conditioning, Heating, and Refrigeration Institute
- **CERTIFICATE NO. :** 133808379192017996

### Elementos gráficos y de página (archivo: AALEF-T-3619N-AHRI, Página 1)
- Logotipo AHRI CERTIFIED (arriba a la izquierda)
- Marca de agua grande "AHRI CERTIFIED www.ahridirectory.org" en el centro
- Logotipo AHRI y lema en la esquina inferior derecha
- Bordes decorativos azules alrededor de la página

Notas finales:
- La transcripción respeta el texto visible en la página 1 del archivo AALEF-T-3619N-AHRI. No se han añadido datos que no aparezcan en el documento.