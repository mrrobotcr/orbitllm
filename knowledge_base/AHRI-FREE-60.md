## AHRI-FREE-60 - Página 1

### Título principal (AHRI-FREE-60 - Página 1)
Certificate of Product Ratings

### Sección: Encabezado de certificación (AHRI-FREE-60 - Página 1)
AHRI CERTIFIED®  
www.ahridirectory.org

### Sección: Detalles del certificado (AHRI-FREE-60 - Página 1)
AHRI Certified Reference Number : 214321054      Date : 06-14-2024      Model Status : Active
...
Outdoor Unit Model Number : AFREE-T-CON6018

Indoor Type : Specific (Non-Ducted)

Indoor Model Number(s) : AFREE-T-CON6018
...
### Sección: Imagen/Marca de agua (AHRI-FREE-60 - Página 1)
(AHRI CERTIFIED® logo and www.ahridirectory.org watermark visible)

### Sección: Notas explicativas y pie de página (AHRI-FREE-60 - Página 1)
...
The Department of Energy has published updated energy efficiency metrics for central air conditioners and heat pump (i.e. WAS) ratings. This publication reflects both the 1987 metric (SEER) and the 2023 metric (SEER2). Efficiency requirements are published at 10 C.F.R. 430.32(c). Please refer to www.AHRI.net for more information about updated energy efficiency metrics.

### Sección: DISCLAIMER (AHRI-FREE-60 - Página 1)
...
### Sección: TERMS AND CONDITIONS (AHRI-FREE-60 - Página 1)
...
### Sección: CERTIFICATE VERIFICATION (AHRI-FREE-60 - Página 1)
...
©2024Air-Conditioning, Heating, and Refrigeration Institute

### Sección: CERTIFICATE NO. (AHRI-FREE-60 - Página 1)
CERTIFICATE NO. : 133626686659523047

### Notas y leyendas (AHRI-FREE-60 - Página 1)
- www.ahridirectory.org (visible under AHRI CERTIFIED® logo)
- AIR-CONDITIONING, HEATING & REFRIGERATION INSTITUTE (logo/text visible at bottom right)
- "we make life better™" (visible near bottom right logo)

(Transcripción realizada exactamente de la página visualizada. No se ha añadido contenido que no aparezca en la imagen.)